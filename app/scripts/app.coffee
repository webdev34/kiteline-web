...
angular.module('kiteLineApp', [
  ...
  $routeProvider.when('/',
    ...
    controller: 'DashboardCtrl').when('/my-accounts',
    templateUrl: 'views/my-accounts/my-accounts.html'
    controller: 'MyAccountsCtrl').when('/messages',
    templateUrl: 'views/messages/messages.html'
    controller: 'MessagesCtrl').when('/messages/:messageId',
    templateUrl: 'views/messages/messages.html'
    controller: 'MessagesCtrl').when('/invoices',
    templateUrl: 'views/invoices/invoices.html'
    controller: 'InvoicesCtrl').when('/invoices/outstanding-invoices/:invoiceId',
    templateUrl: 'views/invoices/invoices.html'
    controller: 'InvoicesCtrl').when('/invoices/payments-made/:payId',
    templateUrl: 'views/invoices/invoices.html'
    controller: 'InvoicesCtrl').when('/invoices/outstanding-balance',
    templateUrl: 'views/invoices/invoices.html'
    controller: 'InvoicesCtrl').when('/my-children',
    templateUrl: 'views/my-children/my-children.html'
    controller: 'MyChildrenCtrl').when('/my-children/:childId',
    templateUrl: 'views/my-children/my-children.html'
    controller: 'MyChildrenCtrl').when('/daily-activity-feed',
