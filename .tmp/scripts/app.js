(function() {
  'use strict';
  angular.module('kiteLineApp', ['ngAnimate', 'ngCookies', 'ngResource', 'ngRoute', 'ngSanitize', 'toastr', 'LocalStorageModule', 'ngScrollbars', 'ngDialog', 'toggle-switch', 'ngMask', '720kb.datepicker', 'angularSpinner', 'credit-cards']).config(function($routeProvider, ScrollBarsProvider) {
    $routeProvider.when('/', {
