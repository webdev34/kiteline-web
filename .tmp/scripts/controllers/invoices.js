(function() {
  'use strict';
  angular.module('kiteLineApp').controller('InvoicesCtrl', function($scope, $rootScope, $filter, $route, $routeParams, $location, StorageService, LogInService, CenterInfoService, ChildService, PaymentService, InvoiceService, InvoiceDetailService, AnnouncementsService, CurbSideService) {
    ...
    $scope.goToViewOutstandingBalance = function() {
      $scope.showBreakDownView = true;
      return $scope.displayView = 'pay outstanding invoice';
    };
